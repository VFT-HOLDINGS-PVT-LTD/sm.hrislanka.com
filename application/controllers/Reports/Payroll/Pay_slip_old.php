...
//        $data['t_date'] = $to_date;
        ...
        if (($this->input->post("cmb_month")) && ($this->input->post("cmb_year"))) {
            if ($filter == '') {
                $filter = "where tbl_salary.Month = '$Month' and tbl_salary.Year = '$year' ";
            } else {
                $filter .= " AND  tbl_salary.Month = '$Month' and tbl_salary.Year = '$year'";
            }
        }
...
// echo $filter;
        ...
        $data['data_set'] = $this->Db_model->getfilteredData("SELECT 
                                                                ...
                                                                FROM
                                                                    ...
                                                                    INNER JOIN 
                                                                    tbl_designations ON tbl_salary.Des_ID = tbl_designations.Des_ID
                                                                        LEFT JOIN
                                                                    ...
                                                                    {$filter} AND tbl_empmaster.EmpNo != '00009000' AND tbl_empmaster.EmpNo != '000000009999'
        ...
        if($data['data_set'] == null){
            // echo "1";
              echo "Payroll has no data for this month";
        }else{
