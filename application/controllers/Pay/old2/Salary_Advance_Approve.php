...
class Salary_Advance_Approve extends CI_Controller {
    ...
    public function index() {
        ...
        $data['data_set'] = $this->Db_model->getfilteredData("SELECT * FROM `tbl_salary_advance` INNER JOIN `tbl_empmaster` ON tbl_salary_advance.EmpNo = tbl_empmaster.EmpNo ORDER BY `tbl_salary_advance`.`id` ASC");
