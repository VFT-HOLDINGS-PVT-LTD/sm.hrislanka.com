                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <!-- <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">Preferred Name</label>
                                                                                <div class="col-sm-8">
                                                                                    <input type="text" class="form-control"  value="<?php echo $data_set[0]->rPerson ?>" id="pNameId" name="pName" placeholder="Preferred name">
                                                                                </div>
                                                                        </div> -->
                                                                        ...
                                                                        <!-- <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <input type="text" class="form-control"  value="<?php echo $data_set[0]->pName ?>" id="rPersonId" name="rPerson" placeholder="Reporting Person">
                                                                            </div>
