                                                        ...
                                                        <div class="tab-pane active" id="horizontal-form">
                                                            <form class="form-horizontal" id="frm_employee" name="frm_employee" action="<?php echo base_url(); ?>Employee_Management/ADD_Employees/insert_Data" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput" class="col-sm-4 control-label">Gender<span style="color: red;">*</span></label>
                                                                        <div class="col-sm-8">
                                                                ...
                                                                <div class="tab-pane" id="vertical-form">
                                                                    ...
                                                                    <div class="form-group col-sm-6">
                                                                        <label for="focusedinput" class="col-sm-4 control-label">Budgetary Allowance <span style="color: red;">*</span></label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" id="txt_BG_Allowance" name="txt_BG_Allowance" required="" placeholder="Ex: 5500">
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="vertical-form">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <div class="form-group col-sm-6">
                                                                            <label for="focusedinput" class="col-sm-4 control-label">E Mail<span style="color: red;">*</span></label>
                                                                            <div class="col-sm-8">
