                                                                    ...
                                                                    <div class="form-group col-md-6">
                                                                        <div class="form-group col-sm-6">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                ...
                                                                                <input type="text" class="form-control" required="" id="txt_from_date" name="txt_from_date" placeholder="Select Date">
                                                                        ...
                                                                        <div class="form-group col-sm-6" style="">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                ...
                                                                                <input type="text" class="form-control" required="" id="txt_to_date" name="txt_to_date" placeholder="Select Date">
...
//                            $('#cmb_cat2').remove();
        ...
        <script>
            ...
            $("#search").click(function () {
                ...
                $('#search_body').load("<?php echo base_url(); ?>Leave_Transaction/Leave_Approve_Adj/search_employee", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(),'txt_from_date': $('#txt_from_date').val(),'txt_to_date': $('#txt_to_date').val()});
            });
