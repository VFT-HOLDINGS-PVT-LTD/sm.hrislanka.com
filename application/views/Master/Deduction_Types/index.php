                                                            ...
                                                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($data_set as $data) : ?>
                                                                        <tr class="odd gradeX">
                                                                            <td width="100"><?php echo $data->Ded_ID; ?></td>
                                                                            <td width="100"><?php echo $data->Deduction_name; ?></td>
                                                                            <td width="100"><?php echo $data->isFixed; ?></td>


                                                                            <td width="15">
                                                                                <button class="get_data btn btn-green" data-toggle="modal" data-target="#myModal" title="EDIT" data-id="<?php echo $data->Ded_ID; ?>" href=""><i class="fa fa-edit"></i></button>
                                                                            </td>
                                                                            <td width="15">
                                                                                <button class="btn btn-danger" data-toggle="modal" href="javascript:void()" title="DELETE" onclick="delete_id(<?php echo $data->Ded_ID; ?>)"><i class="fa fa-times-circle"></i></button>
                                                                            </td>
                                                                        </tr>
                                                                    <?php endforeach; ?>
                                                                </tbody>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form class="form-horizontal" action="<?php echo base_url(); ?>Master/Deduction_Types/update_Data" method="post">
                                                    <div class="form-group col-sm-12">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label for="focusedinput" class="col-sm-4 control-label">Deduction_name</label>
                                                        <div class="col-sm-8">
