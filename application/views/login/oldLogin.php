...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/fonts/font-awesome/css/font-awesome.min.css" type="text/css"
        rel="stylesheet">
...
<body class="focused-form" style="
     background: url(<?php echo base_url(); ?>assets/images/company/header-left.svg) left top no-repeat, linear-gradient(rgb(0 0 0) 20%, rgb(255 0 0) 100%);
    background-size: 83%;
...
">
    ...
    <div class="container" id="login-form">
        <a class="login-logo">
            ...
            <img style="width: 100px; height: 122px;" src="<?php base_url(); ?>
                          ...
                          echo "assets/images/company/logo.jpg"
                              ?>">
        </a>
        <div style="background-image: <?php echo base_url(); ?>assets/images/login-bg.png" class="">
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-default" style=" border: #bbbbbb 1px solid ; border-radius: 10px;
  padding: 10px;
  box-shadow: 1px 3px 5px 5px #ffccff;">
                    <div class="panel-heading ">
                     <h2 style="color: #0079c4"><img style="width: 40px;" src="assets/images/company/VTF-Logo.png"> Login To Payroll System - v2.0</h2>
                    </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="txt_username" name="txt_username"
                                            placeholder="Username" data-parsley-minlength="6" required="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-footer">
                                <div class="clearfix">
                                    ...
                                    <button type="submit" id="btnSubmit" name="btnSubmit"
                                        class="btn btn-info pull-right fa fa-lock">&nbsp;&nbsp;&nbsp;&nbsp;LOGIN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                    <input type="button" id="cancel" name="cancel"
                                        class="btn-danger-alt btn fa fa-check" value="&nbsp;&nbsp;CLEAR">
                ...
                <marquee behavior="alternate" scrolldelay="150">VFT HOLDINGS (PVT) LTD</marquee>
