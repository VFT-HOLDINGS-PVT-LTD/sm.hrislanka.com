...
//                alert(branch_code);
            ...
            <script>
                ...
                $("#search").click(function () {
                    ...
                    $('#search_body').load("<?php echo base_url(); ?>Pay/Salary_Advance/getSal_Advance", {'txt_emp': $('#txt_emp').val(), 'txt_emp_name': $('#txt_emp_name').val(), 'cmb_desig': $('#cmb_desig').val(), 'cmb_dep': $('#cmb_dep').val(), 'cmb_comp': $('#cmb_comp').val(), 'cmb_years': $('#cmb_years').val(), 'cmb_months': $('#cmb_months').val()});
                });
