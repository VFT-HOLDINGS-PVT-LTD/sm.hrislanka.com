                    ...
                    <ul class="acc-menu">
                        ...
                        <?php if ($currentUser[0]->Payroll == 1): ?>
                            ...
                            <ul class="acc-menu">
                                ...
                                <?php if ($currentUser[0]->approve_advance == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Pay/Salary_Advance_Approve/">VIEW SALARY ADVANCE</a></li>
                                <?php endif; ?>
                        ...
                        <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                            ...
                            <?php if ($currentUser[0]->Attendance_Report == 1): ?>
                                ...
                                <?php if ($currentUser[0]->late_report == 1): ?>
                                    <li><a href="<?php echo base_url(); ?>Reports/Attendance/Report_Attendance_ATT_Sum">ATTENDANCE SUMMARY</a></li>
                                <?php endif; ?>
