            ...
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;">IN DATE</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;">IN TIME</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;">OUT DATE</th>
                        <th style="font-size:11px;border-bottom: 1px solid black;">OUT TIME</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:60px;">ST</th>         
                        <th style="font-size:11px;border-bottom: 1px solid black; width:50px;">LATE(M)</th>
                        <th style="font-size:11px;border-bottom: 1px solid black; width:50px;">OT(H:M)</th>   
...
foreach ($data_set as $data) {
    ...
    $html .= ' <tr>
                        ...
                        <td style="font-size:10px;">' . $data->InDate . '</td>
                        <td style="font-size:10px;">' . $data->InTime . '</td>
                        <td style="font-size:10px;">' . $data->OutDate . '</td> 
                        ...
                        <td style="font-size:10px;width:50px;">' . $hours . ':' . $min . '</td>
