...
$pdf->SetTitle('Late_Deduction_Report.pdf');
...
$html = '
        <div style="margin-left:200px; text-align:center; font-size:13px;">LATE DEDUCTION REPORT</div>
            <div style="font-size: 11px; float: left; border-bottom: solid #000 1px;">Year :</div></font><br>
            <table cellpadding="3">
                <thead style="border-bottom: #000 solid 1px;">
                    <tr style="border-bottom: 1px solid black;"> 
                        ...
                        <th style="font-size:11px;border-bottom: 1px solid black;">LATE MINUTES</th>
...
foreach ($data_set as $data) {
    ...
    if ($emtnocheck != $data->EmpNo) {
        $html .= ' <tr>
                <td  style="font-size:10px;border-top: 1px solid black;  width:90px;">' . $data->EmpNo . '</td>
                <td  style="font-size:10px;border-top: 1px solid black;  width:120px;">' . $data->Emp_Full_Name . '</td>
                <td style="font-size:10px;border-top: 1px solid black;  ">' . $data->Date . '</td> 
                <td style="font-size:10px;border-top: 1px solid black;  ">' . $data->amount . '</td>    
                <td style="font-size:10px;border-top: 1px solid black;  ">' . $data->Late_M . '</td>
        ...
        $html .= ' <tr>
                        ...
                        <td style="font-size:10px;">' . $data->Late_M . '</td>
