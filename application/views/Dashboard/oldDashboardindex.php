                                ...
                                <div data-widget-group="group1">
                                    <div class="row">
                                        ...
                                        <?php if ($currentUser[0]->add_employee == 1): ?>
                                            <div  class="col-md-3" >
                                                <a style="background-color: #479cba" class="info-tile has-footer" href="<?php echo base_url(); ?>Employee_Management/ADD_Employees">
                                                    ...
                                                    <div class="tile-body">
                                                        ...
                                                        <div style="color: #ffffff" class="pull-right count"><?php echo $count[0]->count_emp ?></div>
                                                    </div>
                                                    <div class="tile-footer" style="background: #479CBA;
background: linear-gradient(315deg, #479CBA, #34497D);">
                                        ...
                                        <?php if ($currentUser[0]->shift_allocation == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #479cba" class="info-tile has-footer" href="<?php echo base_url(); ?>Attendance/Shift_Allocation">
                                                    ...
                                                    <div style="background: #479CBA;
background: linear-gradient(315deg, #479CBA, #34497D);" class="tile-footer">
                                                        <div style="color: #ffffff"  class="pull-left">SHIFT ALLOCATION</div>
                                                        <div class="pull-right percent-change"></div>
                                                    </div>
                                                </a>
                                        ...
                                        <?php if ($currentUser[0]->attendance_process == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #479cba" class="info-tile has-footer" href="<?php echo base_url(); ?>Attendance/Attendance_Process_test">
                                                    <div class="tile-heading">
...
background: linear-gradient(315deg, #479CBA, #34497D);" class="tile-footer">
                                        ...
                                        <?php if ($currentUser[0]->payroll_process == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #479cba" class="info-tile has-footer" href="<?php echo base_url(); ?>Pay/Payroll_Process/">
                                                    <div class="tile-heading">
...
background: linear-gradient(315deg, #479CBA, #34497D);" class="tile-footer">
                                    ...
                                    <div class="row">
                                        <?php if ($currentUser[0]->leave_request == 1): ?>
                                            ...
                                            <div class="col-md-3">
                                                <a style="background-color: #479cba" class="info-tile has-footer" href="<?php echo base_url(); ?>Leave_Transaction/Leave_Request">
                                                    <div class="tile-heading">
                                                    ...
                                                    <div style="background: rgb(34,96,129);
                                                                                            background: linear-gradient(60deg, rgba(34,96,129,1) 0%, rgba(57,106,129,0.644782913165266) 100%);" class="tile-footer">
                                                        <div style="color: #ffffff"  class="pull-left">APPLY LEAVE</div>
                                                        <div class="pull-right percent-change"></div>
                                                    </div>
                                                </a>
                                        ...
                                        <div class="col-md-3">
                                            <a style="background-color: #479cba" class="info-tile has-footer" href="<?php echo base_url(); ?>Leave_Transaction/Short_Leave_Request">
                                                <div class="tile-heading">
                                                    <div style="color: #ffffff"  class="pull-left">SHORT LEAVE REQUEST</div>
                                                    <div class="pull-right">
                                                        <div id="tileorders" class="sparkline-block"></div>
                                                    </div>
                                                </div>
...
background: linear-gradient(315deg, #479CBA, #34497D);" class="tile-footer">
                                        ...
                                        <?php if ($currentUser[0]->leave_approve == 1): ?>
                                            <div class="col-md-3">
                                                <a style="background-color: #479cba" class="info-tile has-footer" href="<?php echo base_url(); ?>Leave_Transaction/Leave_Approve">
                                                    <div class="tile-heading">
